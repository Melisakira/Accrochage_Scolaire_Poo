...
Le pattern Observer répond directement à cette réalité : chaque intervenant est notifié selon son rôle, de façon indépendante, sans avoir besoin de connaître les autres. 'Eleve' ne sait pas qui compose l'équipe - il notifie, et chacun réagit selon sa propre responsabilité.
